...
description: "I'm no Vim master, but I'll share some frustrations, a minimal setup, and five basic commands to survive—and maybe even make you enjoy the chaos."
pubDate: "Aug 14, 2025"
---
...
The most important command in Vim? The one that gets you out. For me, the most intimidating step was opening a file in
Vim. Because once you do, there's no clue how to close it and get back to where you were. The only alternative was to
close the entire terminal session.
...
Yes, just type that. There's no need to move the cursor or do anything else. *Vim is keyboard-based*.
...
- set better defaults for my workflow
...
There's a huge Vim community, explore the many plugins available. For example, there's an official [Github Copilot
plugin](https://github.com/github/copilot.vim). Who knows, you might find yourself spending far more time in Vim
than you planned...

## Face your fears!

One last tip: face your fears. If you run from them, they will chase you your whole life.

I forced myself to use Vim daily by making it the default Git editor for commits. If you want to do the same, here's how
to configure Git:
