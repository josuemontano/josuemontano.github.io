...
For example, to search for the string "_cache", type `/_cache` and press `Enter`. Press `n` to jump to the next
occurrence. By default, _searches are case sensitive_.
