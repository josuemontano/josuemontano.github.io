...
<AsciinemaPlayer src='/public/casts/2025_08_21_infrastructure_on_a_budget_vps_100.cast' cols={138} rows={26} speed={2} description="Load on the server while serving 100 requests per second"/>
